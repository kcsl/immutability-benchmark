...
{
  private /*@NoRep*/ ORG.as220.tinySQL.tinySQLTableView /*@RepOwn*/ [] views;
  ...
  {
    views = (tinySQLTableView[]) tsTableViews.toArray(new  /*@NoRep*/  tinySQLTableView /*@RepOwn*/ [tsTableViews.size()]);
