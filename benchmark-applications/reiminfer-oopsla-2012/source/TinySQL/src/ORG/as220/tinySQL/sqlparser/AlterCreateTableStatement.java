...
{
  private tinySQL db;
  private  /*@OwnOwn*/  CreateTableStatement cstmt;
   ...
   */
  public AlterCreateTableStatement(/*@NoRep*/ tinySQLStatement statement)
  ...
  {
    return getDatabase().AlterCreateTable(( /*@NoRep*/  AlterCreateTableStatement)this);
  }
