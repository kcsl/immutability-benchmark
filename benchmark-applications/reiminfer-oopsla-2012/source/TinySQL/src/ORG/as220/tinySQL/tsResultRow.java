...
public class tsResultRow extends tsRow
{
  ...
  private tsRow row;
  private /*@NoRep*/ ORG.as220.tinySQL.tsColumn /*@OwnOwn*/ [] myColumns;
  private  /*@NoRep*/  Object /*@OwnPar*/ [] cache;
  ...
  public synchronized Object get(int column) throws tinySQLException
  {
    ...
    if (result == null)
    {
      ...
      if (expr != null)
      {
        result = expr.evaluate(( /*@OwnPar*/   /*@NoRep*/  tsResultRow) this);
        cache[column] = result;
      }
    }
  ...
  public String toString()
  {
    ...
    for (int i = 0; i < size(); i++)
    {
      ...
      try
      {
        b.append(((/*@checkers.inference.reim.quals.Mutable*/ tsResultRow) this).get(i));
      }
      catch (Exception e)
      {
        b.append("<!EXCEPTION>");
