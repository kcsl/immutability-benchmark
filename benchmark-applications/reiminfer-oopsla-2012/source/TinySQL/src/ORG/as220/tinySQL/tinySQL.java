...
public abstract class tinySQL
{
  ...
  // table anymore.
  private  /*@RepRep*/  Hashtable tables;
      ...
      throws tinySQLException
  {
     ...
     */
     /*@NoRep*/  Enumeration tableEnum = select.getTables();
...
//      Log.debug ("Processing Column: " + column);
    ...
    tsResultSet jrs = new tsResultSet(row, select.getResultColumns(), tableColumns, whereC, ( /*@NoRep*/  tinySQL)this);
    try
    {
   ...
   */
  public int UpdateStatement(/*@OwnOwn*/ UpdateStatement upd)
      throws tinySQLException
  {
...
//      }
      ...
      throws tinySQLException
  {
    ...
    try
    {
      ...
      else
      {
        ...
        //
         /*@NoRep*/  Vector values = ins.getValues();
   ...
   */
  public abstract boolean CreateTable( /*@NoRep*/  CreateTableStatement statement)
      throws tinySQLException;
   ...
   */
  public boolean AlterTableAddCol( /*@NoRep*/  AlterTableAddColumnStatement stmt)
      throws tinySQLException
  {
    ...
    try
    {
      ...
      //
      /*@RepRep*/ InsertStatement insert = new InsertStatement(stmt.getStatement());
      insert.setTable(newTableName);

      /*@RepRep*/ SelectStatement select = new SelectStatement(stmt.getStatement());
   ...
   * ALTER CREATE table ...
   */
  public boolean AlterCreateTable(/*@OwnOwn*/ AlterCreateTableStatement stmt)
      throws tinySQLException
  {
    try
    {
      ...
      Vector newnames = new  /*@RepRep*/  Vector();
   ...
   */
  public boolean AlterTableDropCol( /*@NoRep*/  AlterTableDropColumnStatement stmt)
      throws tinySQLException
  {
    tinySQLTableView table = stmt.getTable();
    String tableName = table.getName();
   ...
   */
  public boolean AlterTableRenameCol( /*@NoRep*/  AlterTableRenameColumnStatement stmt)
      throws tinySQLException
  {
   ...
   *
   */
  public void DropTable( /*@NoRep*/  DropTableStatement statement) throws tinySQLException
  {
  ...
  public void close()
  {
    Enumeration enumNew = tables.keys();
    while (enumNew.hasMoreElements())
    {
      String name = (String) enumNew.nextElement();
      try
      {
        closeTable(name);
      }
  ...
  public tinySQLTableView getTable(String table_name) throws tinySQLException
  {
    ...
    /*@OwnOwn*/ tinySQLTableView view = new tinySQLTableView(table);
    return view;
  }
   ...
   *
   */
  public void CompactTable( /*@NoRep*/  CompactTableStatement stmt)
      throws tinySQLException
  {
    tinySQLTableView table = stmt.getTable();
    String tableName = table.getName();
