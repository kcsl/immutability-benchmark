...
//  private static GregorianCalendar cal = new GregorianCalendar ();
  ...
  public static void getColumnElements(Vector v, LValue root)
  {
    ...
    {
      Enumeration enumNew = root.getChildren();
      while (enumNew.hasMoreElements())
      {
        LValue val = (LValue) enumNew.nextElement();
  ...
  /**
   * Builds a vector from a enumNeweration by iterating through the enumNeweration
   * and adding every element to the vector.
   *
   * @return the new vector, which may be empty
   */
  public static Vector buildVector(Enumeration enumNew)
  {
    Vector retval = new  /*@NoRep*/  Vector();
    while (enumNew.hasMoreElements())
    {
      retval.add(enumNew.nextElement());
    }
    return retval;
  }
  ...
  public static String convertToString(Object o)
  {
    ...
    if (o instanceof java.sql.Time)
    {
      ...
      StringBuffer b = new  /*@RepRep*/  StringBuffer(10);
    ...
    if (o instanceof java.util.Date)
    {
      ...
      int mon = cal.get(cal.MONTH);
      int day = cal.get(cal.DAY_OF_MONTH);
      StringBuffer b = new  /*@RepRep*/  StringBuffer(20);
      b.append(Utils.forceToSizeLeft(String.valueOf(year), 4, '0'));
      b.append('-');
      b.append(Utils.forceToSizeLeft(String.valueOf(mon + 1), 2, '0'));
      b.append('-');
