...
public class AlterTableRenameColumnStatement implements SQLStatement
{
   ...
   */
  public AlterTableRenameColumnStatement(/*@OwnOwn*/ tinySQLStatement statement)
  ...
  {
    return getDatabase().AlterTableRenameCol(( /*@NoRep*/  AlterTableRenameColumnStatement)this);
  }
