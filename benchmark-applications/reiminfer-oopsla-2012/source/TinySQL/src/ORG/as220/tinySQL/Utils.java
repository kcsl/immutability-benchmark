...
//      for (int ii = 0; ii<size; ii++) result[ii] = padByte;
    ...
    System.arraycopy(( /*@NoRep*/  Object)tmp, 0, ( /*@NoRep*/  Object)result, 0, tmp.length);
      ...
      throws java.io.UnsupportedEncodingException
  {
    ...
    System.arraycopy(( /*@NoRep*/  Object)tmp, 0, ( /*@NoRep*/  Object)result, padSize, tmp.length);
  ...
  public static String forceToSizeLeft(String str, int size, char padChar)
  {
    ...
    if (str == null)
    {
      tmp = new  /*@RepRep*/  StringBuffer(size);
    }
    else
    {
  ...
  public final static Vector getAllFiles(final String path, final String suffix)
  {
    ...
    File dir = view.createFileObject(path);
     /*@NoRep*/  File /*@RepRep*/ [] ff = view.getFiles(dir, false);
