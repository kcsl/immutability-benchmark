...
public class AlterTableAddColumnStatement implements SQLStatement
{
  ...
  private /*@OwnOwn*/ tinySQLStatement statement;
  private int updateCount;

  /**
   * Creates a ALTER TABLE ADD COLUMN statement.
   */
  public AlterTableAddColumnStatement(/*@OwnOwn*/ tinySQLStatement statement)
  ...
  {
    return getDatabase().AlterTableAddCol(( /*@NoRep*/  AlterTableAddColumnStatement)this);
  }
