...
public class tsColumn
{
  ...
  public int getTablePosition()
  {
    ...
    if (tablePos == -1)
    {
      ((/*@checkers.inference.reim.quals.Mutable*/ tsColumn) this).tablePos = table.findColumn(getPhysicalName());
    }
    return tablePos;
  }
  ...
  private String formColname(String column, tinySQLTableView table)
  {
    ...
    if (fqname == null)
      ((/*@checkers.inference.reim.quals.Mutable*/ tsColumn) this).fqname = table.getName() + "." + column;
    return fqname;
  }
