...
public class CreateTableStatement implements SQLStatement
{
  ...
  private  /*@NoRep*/  Vector columnDefinitions;

  /**
   * creates a new CreateTableStatement.
   */
  public CreateTableStatement(/*@OwnOwn*/ tinySQLStatement statement)
  ...
  {
    return getDatabase().CreateTable(( /*@NoRep*/ CreateTableStatement) this);
  }
