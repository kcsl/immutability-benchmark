...
{
  private  /*@RepRep*/  Hashtable colcache;
  private /*@NoRep*/ tinySQLTable table;
  private int _currentRowNumber;
  private tsRawRow _currentRow;
  private String alias;
  private  /*@NoRep*/  tsColumn  /*@RepRep*/  [] tsColumnCache;
      ...
      throws tinySQLException
  {
    ...
    this.table = table;
    table.createdView(( /*@NoRep*/  tinySQLTableView)this);
    this.alias = alias;
  ...
  public void close() throws tinySQLException
  {
    ...
    table.removedView(( /*@NoRep*/  tinySQLTableView)this);
    isClosed = true;
  }
  ...
  public int findColumn(String name) 
  {
    ...
    for (int i = 0; i < size; i++)
    {
      ...
      {
        ((/*@checkers.inference.reim.quals.Mutable*/ tinySQLTableView) this).colcache.put(name, new Integer(i));
        return i;
      }
    }
  ...
  public tsColumn getColumnDefinition(int column) 
  {
    ...
    {
      ((/*@checkers.inference.reim.quals.Mutable*/ tinySQLTableView) this).tsColumnCache = new tsColumn[table.getColumnCount()];
    }

    if (tsColumnCache[column] == null)
    {
      tsColumn retval = new tsColumn(( /*@NoRep*/  tinySQLTableView)this, table.getColumnDefinition(column));
      ((/*@checkers.inference.reim.quals.Mutable*/ tinySQLTableView) this).tsColumnCache[column] = retval;
    }
