...
public class SelectStatement implements ConditionalStatement
{
  ...
  public SelectStatement(tinySQLStatement statement)
  {
    ...
    tables = new Vector();
    whereC = new WhereClause(( /*@NoRep*/  SelectStatement)this);
    orderC = new OrderByClause(( /*@NoRep*/  SelectStatement)this);
  }
  ...
  /**
   * returns all tables, the statement will be working with, as enumNeweration.
  ...
  {
    Vector v = new Vector((/*@checkers.inference.reim.quals.Mutable*/ java.util.Collection)tableColumns);
      ...
      throws tinySQLException
  {
    try
    {
      /*@NoRep*/ tinySQLConnection c = (tinySQLConnection) statement.getConnection();
      ...
      throws tinySQLException
  {
    ...
    myResult = new tinySQLResultSet(database.SelectStatement(( /*@NoRep*/  SelectStatement)this), getStatement());
    return true;
  }
  ...
  {
    Vector v = new Vector();
    Enumeration valenumNew = getResultColumns().elements();
    while (valenumNew.hasMoreElements())
    {
      tsColumn col = (tsColumn) valenumNew.nextElement();
  ...
  public String toString()
  {
    ...
    Enumeration enumNew = getTableColumns().elements();
    while (enumNew.hasMoreElements())
    {
      b.append(enumNew.nextElement());
      if (enumNew.hasMoreElements())
      {
        b.append(", \n");
      }
    }
    ...
    enumNew = getResultColumns().elements();
    while (enumNew.hasMoreElements())
    {
      b.append(enumNew.nextElement());
      if (enumNew.hasMoreElements())
