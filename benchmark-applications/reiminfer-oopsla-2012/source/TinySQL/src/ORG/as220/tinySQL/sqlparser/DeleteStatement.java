...
public class DeleteStatement implements ConditionalStatement
{
  ...
  public DeleteStatement(/*@OwnOwn*/ tinySQLStatement statement)
      throws tinySQLException
  {
    try
    {
      ...
      whereC = new WhereClause(( /*@NoRep*/ DeleteStatement)this);
    }
  ...
  public boolean execute() throws tinySQLException
  {
    ...
    if (table != null)
    {
      updatecount = getDatabase().DeleteStatement(( /*@NoRep*/  DeleteStatement)this);
    }
