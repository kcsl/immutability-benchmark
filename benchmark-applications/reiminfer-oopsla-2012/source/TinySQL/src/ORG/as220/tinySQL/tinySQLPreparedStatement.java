    ...
    implements PreparedStatement
{
                                  ...
                                  String stCatalog_) throws tinySQLException
  {
    ...
    setStatement(sql.parse(( /*@NoRep*/  tinySQLStatement)this, stSQL_));
  ...
  {
    Enumeration enumNew = parameters.elements();

    //Very simples isn't:
    while (enumNew.hasMoreElements())
    {
      ParameterValue val = (ParameterValue) enumNew.nextElement();
      val.clear();
    }
  }

  //---------------------------------------------------------------------------
  public void setArray(int iIndex_,  /*@OwnPar*/ Array aValue_)
      throws SQLException
  {
  ...
  //---------------------------------------------------------------------------
  public void setBlob(int iIndex_,  /*@OwnPar*/  Blob blobValue_)
      throws SQLException
  {
    //Opps i did it again!
  ...
  //---------------------------------------------------------------------------
  public void setClob(int iIndex_,  /*@OwnPar*/ Clob clobValue_)
      throws SQLException
  {
