...
public class InsertStatement implements SQLStatement
{
  ...
  private  /*@NoRep*/  Vector columns; // Vector of tsRows
  private  /*@NoRep*/  Vector tablesCache;
  private  /*@NoRep*/  Vector values;
  ...
  public boolean execute() throws tinySQLException
  {
    if (table != null)
    {
      updatecount = getDatabase().InsertStatement(( /*@NoRep*/  InsertStatement)this);
    }
    return false;
  }
