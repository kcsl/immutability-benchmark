...
public class Expression implements LValue
{
  ...
  private  /*@RepRep*/  Vector addValues;
  ...
  {
    /*@RepRep*/ ValueContainer vc = new ValueContainer(op, value);
    addValues.add(0, vc);
    value = lv;
  }
  ...
  public Object evaluate(tsRow rowdata) throws tinySQLException
  {
    ...
    {
       /*@NoRep*/  ValueContainer valcon = (ValueContainer) addValues.get(i);
  ...
  public String getName() 
  {
    ...
    if (transformed == false)
    {
      ...
      ((/*@checkers.inference.reim.quals.Mutable*/ Expression) this).transformExpression();
      ((/*@checkers.inference.reim.quals.Mutable*/ Expression) this).transformed = true;
    }

    StringBuffer b = new  /*@RepRep*/ StringBuffer(getValueName(value));
  ...
  {
    DriverManager.setLogWriter(new  /*@OwnPar*/  PrintWriter(System.out));
