...
public class UpdateStatement implements ConditionalStatement
{
   ...
   * <code>statement</code>.
   */
  public UpdateStatement(/*@OwnOwn*/ tinySQLStatement statement)
      throws tinySQLException
  {
    try
    {
      ...
      whereC = new WhereClause(( /*@NoRep*/  UpdateStatement)this);
    }
  ...
  public boolean execute() throws tinySQLException
  {
    ...
    if (table != null)
    {
      updateCount = getDatabase().UpdateStatement(( /*@NoRep*/  UpdateStatement)this);
    }
    return false;
  }
  ...
  public String toString()
  {
    ...
    for (int i = 0; i < row.size(); i++)
    {
      ...
      try
      {
        b.append(((/*@checkers.inference.reim.quals.Mutable*/ tsResultRow) row).get(i));
      }
      catch (Exception e)
      {
        b.append("<!EXCEPTION>");
