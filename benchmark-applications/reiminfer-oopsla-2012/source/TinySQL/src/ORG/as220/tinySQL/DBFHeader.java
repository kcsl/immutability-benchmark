...
public class DBFHeader
{
  ...
  */
  ...
  private  /*@NoRep*/  Vector coldefsSorted;
  ...
  public DBFHeader(DBFHeader old, int numFields, String encoding) throws tinySQLException
  {
    ...
    System.arraycopy(( /*@NoRep*/  Object)old.fileHeader, 0, ( /*@NoRep*/  Object)fileHeader, 0, DBF_HEADER_SIZE);
    applyFileHeader();
  ...
  public Vector getFields()
  {
    ...
    Enumeration enumNew = coldefsSorted.elements();
    while (enumNew.hasMoreElements())
    {
      tsColumn col = new tsColumn((tsColumn) enumNew.nextElement());
      v.addElement(col);
    }
...
//    if (type.equals('B')) return java.sql.Types.DOUBLE;   // MS FoxPro
  ...
  public void copyDBFHeader(DBFHeader header) throws tinySQLException
  {
    ...
    System.arraycopy(( /*@NoRep*/  Object)header.fileHeader, 0, ( /*@NoRep*/  Object)newFileHeader, 0, DBF_HEADER_SIZE);
    ...
    if (type == TYPE_VISUAL_FOXPRO)
    {
      ...
      System.arraycopy(( /*@NoRep*/  Object)colHeader, 0, ( /*@NoRep*/  Object)newColHeader, 0, colHeader.length);
      System.arraycopy(( /*@NoRep*/  Object)header.colHeader, normColHeaderLength, ( /*@NoRep*/  Object)newColHeader, 0, BACKLINK_STRUCTURE_SIZE);
    }
    else
    {
