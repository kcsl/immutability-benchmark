...
public abstract class tinySQLConnection implements java.sql.Connection
{
      ...
      throws SQLException
  {
    ...
    tsql.setConnection(( /*@NoRep*/  tinySQLConnection)this);
  }
  ...
  {
    return (Statement) new tinySQLStatement(( /*@NoRep*/  tinySQLConnection)this);
  }
  ...
  public PreparedStatement prepareStatement(String sql)
      throws SQLException
  {
    return new tinySQLPreparedStatement(( /*@NoRep*/  tinySQLConnection)this, sql, getCatalog());
  }
