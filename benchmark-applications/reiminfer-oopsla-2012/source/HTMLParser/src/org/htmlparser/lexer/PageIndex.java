        ...
        Sortable
{
    ...
    public int add (Cursor cursor)
    {
        ...
        else
        {
            ...
            if (position == last)
                ...
                {
        	        // find where it goes
        	        ret = Sort.bsearch ((/*@OwnPar*/ /*@NoRep*/ PageIndex)this, cursor);
    ...
    public void remove (Cursor cursor)
    {
        ...
        // find it
        i = Sort.bsearch ((/*@OwnPar*/ /*@NoRep*/ PageIndex)this, cursor);
    ...
    {
        return (Sort.bsearch ((/*@OwnPar*/ /*@NoRep*/ PageIndex)this, new Cursor (getPage (), cursor)));
    }
    ...
    {
        return (Sort.bsearch ((/*@OwnPar*/ /*@NoRep*/ PageIndex)this, new Cursor (getPage (), cursor), first, last));
    }
