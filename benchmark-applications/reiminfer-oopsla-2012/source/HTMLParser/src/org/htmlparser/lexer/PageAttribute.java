    ...
    public String getName ()
    {
        ...
        if (null == ret)
        {
            if ((null != mPage) && (0 <= mNameStart))
            {
                ...
                ((/*@checkers.inference.reim.quals.Mutable*/ PageAttribute) this).setName (ret); // cache the value
            }
        }
    ...
    public String getAssignment ()
    {
        ...
        if (null == ret)
        {
            if ((null != mPage) && (0 <= mNameEnd) && (0 <= mValueStart))
            {
                ...
                ((/*@checkers.inference.reim.quals.Mutable*/ PageAttribute) this).setAssignment (ret); // cache the value
            }
        }
    ...
    public String getValue ()
    {
        ...
        if (null == ret)
        {
            if ((null != mPage) && (0 <= mValueEnd))
            {
                ...
                ((/*@checkers.inference.reim.quals.Mutable*/ PageAttribute) this).setValue (ret); // cache the value
            }
        }
