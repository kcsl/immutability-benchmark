        ...
        Serializable
{
     ...
     */
    protected /*@RepOwn*/ Source mSource;

    /**
     * Character positions of the first character in each line.
     */
    protected /*@RepRep*/ PageIndex mIndex;
            ...
            UnsupportedEncodingException
    {
        ...
        mIndex = new PageIndex ((/*@OwnPar*/ /*@NoRep*/ Page)this);
        mConnection = null;
        mUrl = null;
        mBaseUrl = null;
    }
...
//                    }
     ...
     */
    private void writeObject (/*@RepRep*/ ObjectOutputStream out)
        throws
            IOException
    {
        String href;
            ...
            ClassNotFoundException
    {
        ...
        if (fromurl)
        {
            ...
            cursor = new Cursor ((/*@OwnPar*/ /*@NoRep*/ Page)this, 0);
    ...
    {
        getSource ().reset ();
        mIndex = new PageIndex ((/*@OwnPar*/ /*@NoRep*/ Page)this); // todo: is this really necessary?
    }
...
//                System.out.println (msg.toString ());
     ...
     */
    public String getLine (/*@NoRep*/ Cursor cursor)
    {
        int line;
        int size;
        int start;
    ...
    {
        return (getLine (new Cursor ((/*@OwnPar*/ /*@NoRep*/ Page)this, position)));
    }
