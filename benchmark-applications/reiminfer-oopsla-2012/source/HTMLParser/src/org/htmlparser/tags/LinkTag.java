...
public class LinkTag extends CompositeTag
{
    ...
    public String getLink() 
    {
        if (null == mLink)
        {
            ((/*@checkers.inference.reim.quals.Mutable*/ LinkTag) this).mailLink=false;
            ((/*@checkers.inference.reim.quals.Mutable*/ LinkTag) this).javascriptLink = false;
            ((/*@checkers.inference.reim.quals.Mutable*/ LinkTag) this).mLink = extractLink ();
            ...
            if (mailto==0)
            {
                ...
                ((/*@checkers.inference.reim.quals.Mutable*/ LinkTag) this).mLink = mLink.substring(mailto+1);
                ((/*@checkers.inference.reim.quals.Mutable*/ LinkTag) this).mailLink = true;
            }
            int javascript = mLink.indexOf("javascript:");
            if (javascript == 0)
            {
                ((/*@checkers.inference.reim.quals.Mutable*/ LinkTag) this).mLink = mLink.substring(11); // this magic number is "javascript:".length()
                ((/*@checkers.inference.reim.quals.Mutable*/ LinkTag) this).javascriptLink = true;
            }
        }
        return (mLink);
    }
     ...
     */
    public String toString()  /*checkers.inference.reim.quals.Readonly*/
    {
