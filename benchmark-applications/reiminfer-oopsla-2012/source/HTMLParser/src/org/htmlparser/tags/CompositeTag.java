...
public class CompositeTag extends TagNode
{
    ...
    public SimpleNodeIterator children ()
    {
        ...
        if (null != getChildren ())
            ...
            ret = (new /*@RepOwn*/ NodeList ()).elements ();
    ...
    {
        return (
            (null == getChildren ()) ? new /*@RepOwn*/ NodeList ().elements () :
...
//        if (!(endTag.getStartPosition () == endTag.getEndPosition ()))
    ...
    public void accept (NodeVisitor visitor)
    {
        ...
        if (visitor.shouldRecurseSelf ())
            visitor.visitTag ((/*@OwnPar*/ /*@NoRep*/ CompositeTag)this);
    ...
    public Text[] digupStringNode(String searchText) {
        ...
        /*@NoRep*/ org.htmlparser.Text /*@OwnOwn*/ [] stringNode = new Text[stringNodes.size()];
