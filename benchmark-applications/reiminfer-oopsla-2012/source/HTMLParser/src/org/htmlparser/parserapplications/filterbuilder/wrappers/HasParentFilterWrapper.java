        ...
        ActionListener
{
    ...
    public HasParentFilterWrapper ()
    {
        ...
        add (mRecursive);
        mRecursive.addActionListener ((/*@OwnPar*/ /*@NoRep*/ HasParentFilterWrapper)this);
        mRecursive.setSelected (mFilter.getRecursive ());

        // add the subfilter container
        mContainer = new SubFilterList ((/*@OwnPar*/ /*@NoRep*/ HasParentFilterWrapper)this, "Parent Filter", 1);
        add (mContainer);
    }
     ...
     */
    public void setSubNodeFilters (/*@NoRep*/ org.htmlparser.NodeFilter /*@NoRep*/ [] filters)
    {
        if (0 != filters.length)
