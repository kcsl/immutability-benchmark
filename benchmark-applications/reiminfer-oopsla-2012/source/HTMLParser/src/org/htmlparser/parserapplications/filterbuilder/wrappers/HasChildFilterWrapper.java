        ...
        ActionListener
{
    ...
    public HasChildFilterWrapper ()
    {
        ...
        add (mRecursive);
        mRecursive.addActionListener ((/*@OwnPar*/ /*@NoRep*/ HasChildFilterWrapper)this);
        mRecursive.setSelected (mFilter.getRecursive ());

        // add the subfilter container
        mContainer = new SubFilterList ((/*@OwnPar*/ /*@NoRep*/ HasChildFilterWrapper)this, "Child Filter", 1);
        add (mContainer);
    }
