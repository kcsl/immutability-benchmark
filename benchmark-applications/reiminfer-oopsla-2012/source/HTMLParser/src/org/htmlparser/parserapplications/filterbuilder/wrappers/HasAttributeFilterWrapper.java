        ...
        DocumentListener
{
     ...
     */
    protected /*@OwnPar*/ JCheckBox mValued;
    ...
    public HasAttributeFilterWrapper ()
    {
        ...
        mAttributeName.addActionListener ((/*@OwnPar*/ /*@NoRep*/ HasAttributeFilterWrapper)this);
        ...
        mValued.addActionListener ((/*@OwnPar*/ /*@NoRep*/ HasAttributeFilterWrapper)this);
        ...
        mAttributeValue.getDocument ().addDocumentListener ((/*@OwnPar*/ /*@NoRep*/ HasAttributeFilterWrapper)this);
    }
     ...
     */
    protected void addAttributes (/*@RepRep*/ Set set, Node node)
    {
        Vector attributes;
        Attribute attribute;
        String name;
     ...
     * @param node The node with attributes to add.
     */
    protected void addAttributeValues (/*@RepRep*/ Set set, Node node)
    {
        Vector attributes;
        Attribute attribute;
        String value;
    ...
    public void setNodeFilter (NodeFilter filter, Parser context)
    {
        ...
        for (/*@RepRep*/ Iterator iterator = set.iterator (); iterator.hasNext (); )
