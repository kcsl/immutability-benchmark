        ...
        ClipboardOwner
{
     ...
     * Selected commands.
     */
    protected /*@NoRep*/ Vector mSelection;
     ...
     */
    protected /*@RepRep*/ DropTarget mDropTarget;
    
    /**
     * Enables this component to be a Drag Source.
     */
    protected /*@RepRep*/ DragSource mDragSource;
     ...
     */
    protected /*@NoRep*/ JPanel mMainPanel;

    /**
     * The main panel scrolling GUI component.
     */
    protected /*@NoRep*/ JScrollPane mMainScroller;
    ...
    public FilterBuilder ()
    {
        ...
        mDropTarget = new DropTarget (mMainPanel, (/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
        ...
        item.addActionListener ((/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
        menu.add (item);
        item = new JMenuItem ();
...
//        mTextField.addActionListener (this);
        ...
        // listeners
        addWindowListener ((/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
        setIconImage (Toolkit.getDefaultToolkit ().getImage ("images/program16.gif"));
        addMouseListener ((/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
        addMouseMotionListener ((/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
            ...
            JMenu menu)
    {
        ...
        if (null != toolbar)
        {
            ...
            button.setIcon (icon);
            button.addActionListener ((/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
            toolbar.add (button);
        }
    }
        ...
        throws MalformedURLException
    {
        ...
        if (null == (ret = ((/*@NoRep*/ Class) getClass ()).getResource (spec)))
    ...
    public JButton makeFilterButton (String class_name)
    {
        ...
        if (null != filter)
        {
            ...
            mDragSource.createDefaultDragGestureRecognizer (
                ...
                (/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
            ret.setActionCommand ("filterAction");
            ret.addActionListener ((/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
        }
...
//            item.setMnemonic (mnemonic);
     ...
     */
    protected void makeProgram (String name, StringBuffer out, /*@RepRep*/ FilterBean bean)
    {
    ...
    {
        /*@RepRep*/ FileDialog dialog;
        File file;

        dialog = new FileDialog ((/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
    ...
    protected void cutAction ()
    {
        ...
        cb.setContents (contents, (/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
    ...
    protected void pasteAction ()
    {
        ...
        // get the text
        cb = Toolkit.getDefaultToolkit ().getSystemClipboard ();
        content = cb.getContents ((/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
...
//                    ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED));
    ...
    public void setupMouseListeners (Filter[] filters)
    {
        ...
        for (int i = 0; i < filters.length; i++)
        {
            ...
            ((Component)filters[i]).addMouseListener ((/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
            ((Component)filters[i]).addMouseMotionListener ((/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
        ...
        for (int i = 0; i < filters.length; i++)
        {
            ...
            if (null != list)
            {
                ...
                for (int j = 0; j < components.length; j++)
                    new DropTarget (components[j], (/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
     ...
     */
    public void showContextMenu (/*@OwnPar*/ MouseEvent event)
    {
        /*@OwnPar*/ JPopupMenu menu;
        /*@OwnPar*/ JMenuItem item;
     ...
     */
    public void mouseClicked (/*@OwnPar*/ MouseEvent event)
    {
        Object component;
        Filter filter;
        SubFilterList list;
     ...
     */
    public synchronized void mouseDragged (/*@OwnPar*/ MouseEvent event)
    {
        Object component;
        Filter filter;
        Point base;
...
//        }
        ...
        if (null != action)
            try
            {
                ...
                method.invoke ((/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this, new /*@OwnPar*/ Object[0]);
            }
    ...
    public void dragGestureRecognized (DragGestureEvent event)
    {
        ...
        try
        {
            ...
            if (null != cls)
            {
                ...
                mDragSource.startDrag (event, DragSource.DefaultMoveDrop, text, (/*@OwnPar*/ /*@NoRep*/ FilterBuilder)this);
            }
        }
        catch (Exception e)
        {
     ...
     */
    public void drop (/*@OwnPar*/ DropTargetDropEvent event)
    {
        /*@OwnPar*/ DropTargetContext context;
        Component component;
        SubFilterList list;
        String s;
        Point point;
