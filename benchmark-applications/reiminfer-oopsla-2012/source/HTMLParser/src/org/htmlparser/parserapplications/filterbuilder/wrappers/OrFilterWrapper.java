        ...
        Filter
{
     ...
     */
    protected /*@OwnOwn*/ OrFilter mFilter;
    ...
    public OrFilterWrapper ()
    {
        ...
        mContainer = new SubFilterList ((/*@OwnPar*/ /*@NoRep*/ OrFilterWrapper)this, "Predicates", 0);
        add (mContainer);
    }
    ...
    {
        /*@NoRep*/ org.htmlparser.NodeFilter /*@NoRep*/ [] predicates;
        NodeFilter[] temp;
        OrFilter ret;
