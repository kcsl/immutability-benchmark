        ...
        Runnable
{
    ...
    public StringFilterWrapper ()
    {
        ...
        add (mPattern);
        mPattern.getDocument ().addDocumentListener ((/*@OwnPar*/ /*@NoRep*/ StringFilterWrapper)this);
        ...
        mCaseSensitivity.addActionListener ((/*@OwnPar*/ /*@NoRep*/ StringFilterWrapper)this);
        ...
        synchronized (mLocale)
        {
            ...
            thread = new Thread ((/*@OwnPar*/ /*@NoRep*/ StringFilterWrapper)this);
            thread.setName  ("locale_getter");
            thread.setPriority (Thread.MIN_PRIORITY);
            thread.run ();
        }
        add (mLocale);
        mLocale.addActionListener ((/*@OwnPar*/ /*@NoRep*/ StringFilterWrapper)this);
