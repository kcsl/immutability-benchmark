        ...
        NodeFilter
{
    ...
    public static byte[] pickle (Object object)
        throws
            IOException
    {
        /*@RepOwn*/ ByteArrayOutputStream bos;
        /*@RepOwn*/ ObjectOutputStream oos;
        byte[] ret;
    ...
    {
        /*@RepOwn*/ ByteArrayInputStream bis;
        /*@RepOwn*/ ObjectInputStream ois;
        Object ret;
        ...
        if (selected)
            setBorder (
                new CompoundBorder (
                    new EtchedBorder (),
                    new CompoundBorder (
                        new /*@OwnPar*/ LineBorder(Color.blue, 2),
    ...
    {
        /*@NoRep*/ java.awt.Component /*@OwnPar*/ [] components;
