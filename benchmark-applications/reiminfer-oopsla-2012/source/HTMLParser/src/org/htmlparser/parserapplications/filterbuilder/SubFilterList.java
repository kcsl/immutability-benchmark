        ...
        JPanel
{
     ...
     */
    public SubFilterList (/*@OwnPar*/ Filter home, String title, int max)
    {
        mHome = home;
        mTitle = title;
        mMax = max;
    	    ...
    	    setBorder (
    		        new CompoundBorder (
    		            new TitledBorder (
    	                    ...
    	                    TitledBorder.TOP),
    	                    new CompoundBorder (
	                            new /*@OwnPar*/ LineBorder (Color.green, 2),
    ...
    {
        return (new /*@NoRep*/ Component[] { (/*@OwnPar*/ /*@NoRep*/ SubFilterList)this });
    }
    ...
    {
        /*@NoRep*/ org.htmlparser.NodeFilter /*@NoRep*/ [] before;
        /*@NoRep*/ org.htmlparser.NodeFilter /*@NoRep*/ [] after;
        int offset;
