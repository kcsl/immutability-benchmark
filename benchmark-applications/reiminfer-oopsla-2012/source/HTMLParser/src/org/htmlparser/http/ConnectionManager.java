...
public class ConnectionManager
{
     ...
     */
    protected /*@RepRep*/ Hashtable mCookieJar;
     ...
     */
    public URLConnection openConnection (/*@RepOwn*/ URL url)
        throws
            ParserException
    {
        /*@OwnPar*/ Properties sysprops;
     ...
     */
    protected Vector addCookies (Vector cookies, String path, /*@RepNorep*/ Vector list)
    {
        Cookie cookie;
        Date expires;
        Date now;
...
//                            |       "Version" "=" 1*DIGIT
     ...
     */
    protected void saveCookies (/*@RepNorep*/ Vector list, URLConnection connection)
    {
        Cookie cookie;
        String domain;
