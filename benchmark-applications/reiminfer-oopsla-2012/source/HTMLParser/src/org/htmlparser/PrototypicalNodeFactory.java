        ...
        NodeFactory
{
     ...
     */
    protected /*@RepOwn*/ Text mText;

    /**
     * The prototypical remark node.
     */
    protected /*@RepOwn*/ Remark mRemark;
     ...
     */
    protected /*@RepRep*/ Map mBlastocyst;
     ...
     */
    public PrototypicalNodeFactory (/*@NoRep*/ org.htmlparser.Tag /*@RepRep*/ [] tags)
    {
        this (true);
    ...
    public PrototypicalNodeFactory registerTags ()
    {
        ...
        return ((/*@OwnPar*/ /*@NoRep*/ PrototypicalNodeFactory)this);
    }
