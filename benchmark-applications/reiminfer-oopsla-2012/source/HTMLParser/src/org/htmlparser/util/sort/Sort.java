...
public class Sort
{
     ...
     */
    public static void QuickSort (/*@OwnOwn*/ Sortable sortable, int lo0, int hi0)
    {
        int lo = lo0;
        int hi = hi0;
        Ordered mid;
     ...
     * are not <code>Ordered</code>.
     */
    public static Object[] QuickSort (/*@RepRep*/ Hashtable h) throws ClassCastException
    {
        /*@RepNorep*/ Enumeration e;
        boolean are_strings;
        Object[] ret;
     ...
     */
    public static int bsearch (/*@OwnPar*/ Sortable set, Ordered ref, int lo, int hi)
    {   int num;
        int mid;
        Ordered ordered;
        int half;
     ...
     * @return The index at which reference was found or is to be inserted.
     */
    public static int bsearch (/*@OwnPar*/ Sortable set, Ordered ref)
    {
     ...
     * @return The index at which reference was found or is to be inserted.
     */
    public static int bsearch (Ordered[] array, /*@OwnOwn*/ Ordered ref, int lo, int hi)
    {   int num;
        int mid;
        int half;
        int result;
     ...
     * @return The index at which reference was found or is to be inserted.
     */
    public static int bsearch (Ordered[] array, /*@OwnOwn*/ Ordered ref)
    {
