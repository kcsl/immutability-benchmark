        ...
        HierarchyListener
{
     ...
     * The display mosaic.
     */
    protected /*@ParPar*/ TileSet mMosaic;
    ...
    public PicturePanel (final Thumbelina thumbelina)
    {
        ...
        addMouseListener ((/*@OwnPar*/ /*@NoRep*/ PicturePanel)this);
        addHierarchyListener ((/*@OwnPar*/ /*@NoRep*/ PicturePanel)this);
    }
    ...
    {
        /*@ParPar*/ Enumeration enumeration;
        Picture picture;
        Picture ret;
     ...
     */
    public void adjustClipForInsets (final /*@OwnPar*/ Graphics graphics)
    {
        Dimension dim;
        Insets insets;
        Rectangle clip;
     ...
     */
    public void paint (final /*@OwnPar*/ Graphics graphics)
    {
        /*@OwnPar*/ Rectangle clip;
        /*@ParPar*/ Enumeration enumeration;
        /*@RepPar*/ HashSet set; // just so we don't draw things twice
        /*@ParPar*/ Picture picture;
        /*@ParPar*/ Image image;
        Point origin;
        int width;
        int height;
                ...
                while (enumeration.hasMoreElements ())
                {
                    ...
                    if ((null == clip) || (clip.intersects (picture)))
                    {
                        ...
                        if (!set.contains (image))
                        {
                            ...
                            width = image.getWidth ((/*@OwnPar*/ /*@NoRep*/ PicturePanel)this);
                            height = image.getHeight ((/*@OwnPar*/ /*@NoRep*/ PicturePanel)this);
                            graphics.drawImage (picture.getImage (),
                                origin.x, origin.y,
                                origin.x + width, origin.y + height,
                                0, 0, width, height,
                                (/*@OwnPar*/ /*@NoRep*/ PicturePanel)(/*@OwnPar*/ /*@NoRep*/ PicturePanel)this);
                            set.add (image);
                        }
                    }
                }
    ...
    public void hierarchyChanged (final HierarchyEvent event)
    {
        if (0 != (event.getChangeFlags () & HierarchyEvent.PARENT_CHANGED))
        {
            ...
            if ((null != parent) && (parent.getParent () == dad))
                dad.addComponentListener ((/*@OwnPar*/ /*@NoRep*/ PicturePanel)this);
        }
    }
}
