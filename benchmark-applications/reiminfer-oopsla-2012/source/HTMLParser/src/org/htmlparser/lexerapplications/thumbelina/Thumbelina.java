        ...
        ListSelectionListener
{
     ...
     * URL's to visit.
     */
    private /*@RepRep*/ ArrayList mUrls;

    /**
     * URL's visited.
     */
    protected /*@RepNorep*/ HashMap mVisited;

    /**
     * Images requested.
     */
    protected /*@RepNorep*/ HashMap mRequested;

    /**
     * Images being tracked currently.
     */
    protected /*@RepNorep*/ HashMap mTracked;

    /**
     * Background thread.
     */
    protected /*@RepRep*/ Thread mThread;
     ...
     */
    protected /*@RepRep*/ Sequencer mSequencer;

    /**
     * The central area for pictures.
     */
    protected /*@OwnPar*/ PicturePanel mPicturePanel;
     ...
     */
    protected /*@OwnPar*/ PropertyChangeSupport mPropertySupport;
     ...
     * History list.
     */
    protected /*@OwnPar*/ JList mHistory;
    ...
    public Thumbelina (final URL url)
    {
        ...
        mThread = null;
        mActive = true;
        mPicturePanel = new PicturePanel ((/*@OwnPar*/ /*@NoRep*/ Thumbelina)this);
        mSequencer = new Sequencer ((/*@OwnPar*/ /*@NoRep*/ Thumbelina)this);
        mPropertySupport = new PropertyChangeSupport ((/*@OwnPar*/ /*@NoRep*/ Thumbelina)this);
        mCurrentURL = null;
        mDiscardCGI = true;
        ...
        mThread = new Thread ((/*@OwnPar*/ /*@NoRep*/ Thumbelina)this);
        mThread.setName ("BackgroundThread");
        mThread.start ();
        initComponents ();

        mRunToggle.addItemListener ((/*@OwnPar*/ /*@NoRep*/ Thumbelina)this);
        mBackgroundToggle.addItemListener ((/*@OwnPar*/ /*@NoRep*/ Thumbelina)this);
        mSpeedSlider.addChangeListener ((/*@OwnPar*/ /*@NoRep*/ Thumbelina)this);
        mHistory.addListSelectionListener ((/*@OwnPar*/ /*@NoRep*/ Thumbelina)this);
     ...
     */
    public void append (final /*@RepNorep*/ ArrayList list)
    {
     ...
     */
    protected ArrayList filter (final /*@NoRep*/ java.net.URL /*@OwnOwn*/ [] urls)
    {
        /*@RepNorep*/ ArrayList list;
        URL url;
        String ref;
    ...
    protected URL[][] extractImageLinks (final Lexer lexer, final URL docbase)
        throws
            ...
            ParserException
    {
        /*@RepRep*/ HashMap images;
        /*@RepRep*/ HashMap links;
        ...
        ((/*@NoRep*/  java.util.Collection)images.values ()).toArray (ret[0]);
        ret[1] = new URL[links.size ()];
        ((/*@NoRep*/  java.util.Collection)links.values ()).toArray (ret[1]);
    ...
    class Enqueuer extends Thread
    {
        ...
        public void run ()
        {
            ...
            synchronized (mEnqueuers)
            {
                mEnqueuers.remove ((/*@OwnPar*/ /*@NoRep*/ Enqueuer)this);
            }
        }
    }
    //
            ...
            for (int i = 0; i < hrefs.length; i++)
            {
                ...
                if (null != picture)
                    ...
                    try
                    {
                        ...
                        image = ((/*@OwnPar*/ java.awt.Toolkit) getToolkit ()).createImage (url);
