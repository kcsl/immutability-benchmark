        ...
        PropertyChangeListener
{
    ...
    {
        setTitle (TITLE);
        thumbelina.addPropertyChangeListener ((/*@OwnPar*/ /*@NoRep*/ ThumbelinaFrame)this);
        getContentPane ().add (thumbelina, BorderLayout.CENTER);
        addWindowListener ((/*@OwnPar*/ /*@NoRep*/ ThumbelinaFrame)this);
        makeMenu ();
        setJMenuBar (mMenu);
        restoreSize ();
        initState ();
    ...
    public void makeMenu ()
    {
        ...
        mOpen.addActionListener ((/*@OwnPar*/ /*@NoRep*/ ThumbelinaFrame)this);
        mGoogle.addActionListener ((/*@OwnPar*/ /*@NoRep*/ ThumbelinaFrame)this);
        mExit.addActionListener ((/*@OwnPar*/ /*@NoRep*/ ThumbelinaFrame)this);
        mStatusVisible.addItemListener ((/*@OwnPar*/ /*@NoRep*/ ThumbelinaFrame)this);
        mHistoryVisible.addItemListener ((/*@OwnPar*/ /*@NoRep*/ ThumbelinaFrame)this);
        mReset.addActionListener ((/*@OwnPar*/ /*@NoRep*/ ThumbelinaFrame)this);
        mClear.addActionListener ((/*@OwnPar*/ /*@NoRep*/ ThumbelinaFrame)this);
        mAbout.addActionListener ((/*@OwnPar*/ /*@NoRep*/ ThumbelinaFrame)this);
    }
        ...
        if ((-1 != start) && (-1 != end))
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (!"".equals (string))
                {
                    ...
                    item.setText (string);
                    item.addActionListener ((/*@OwnPar*/ /*@NoRep*/ ThumbelinaFrame)this);
                    mURL.add (item, start++);
                }
            }
        }
    ...
    public void open ()
    {
        ...
        result = JOptionPane.showInputDialog (
            (/*@OwnPar*/ /*@NoRep*/ ThumbelinaFrame)(/*@OwnPar*/ /*@NoRep*/ ThumbelinaFrame)this,
            "Enter the URL:",
            "Open URL",
